...
public:
    ...
    DirectoryIndexHandler(const IndexHandler &) = delete;
    DirectoryIndexHandler(IndexHandler &&) = delete;

    virtual ~DirectoryIndexHandler() {};

    DirectoryIndexHandler &operator=(const IndexHandler &) = delete;
    DirectoryIndexHandler &operator=(IndexHandler &&) = delete;

    virtual HTTPResponse makeResponseForDir(const std::string &dir_path, const std::string &url_path);
};
